...
import UdayjCheckersUdayjCheckersCheckers from './udayj/checkers/udayj.checkers.checkers'
...
export default { 
  ...
  UdayjCheckersUdayjCheckersCheckers: load(UdayjCheckersUdayjCheckersCheckers, 'udayj.checkers.checkers'),
