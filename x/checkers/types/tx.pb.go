...
func init() {
	proto.RegisterType((*MsgCreatePost)(nil), "udayj.checkers.checkers.MsgCreatePost")
	proto.RegisterType((*MsgCreatePostResponse)(nil), "udayj.checkers.checkers.MsgCreatePostResponse")
}
...
var fileDescriptor_b89f7ca8d0309536 = []byte{
	...
	0x4d, 0x49, 0xac, 0xcc, 0xd2, 0x83, 0x49, 0xc0, 0x19, 0x4a, 0xc1, 0x5c, 0xbc, 0xbe, 0xc5, 0xe9,
	...
	0xff, 0xff, 0x61, 0x45, 0xeb, 0x7b, 0x55, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) CreatePost(ctx context.Context, in *MsgCreatePost, opts ...grpc.CallOption) (*MsgCreatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/udayj.checkers.checkers.Msg/CreatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/udayj.checkers.checkers.Msg/CreatePost",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "udayj.checkers.checkers.Msg",
